...
object MockHelper {
    ...
    */
   fun mockChooseFileDialog(fileChosen: String) {
      mockkObject(ChooseFileDialog)
      every { ChooseFileDialog.showAndWait(any(), any(), any(), any()) } returns DialogResult(true, File(fileChosen))
   }
}